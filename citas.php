            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (!empty($citas)) {
                    ...
                    foreach ($citas as $cita) {
                        ...
                        echo "<td><form method='POST' action='Logica/updateCita.php'><input type='hidden' name='idCita' value='{$cita['idCita']}'><button type='submit' class='btn btn-danger'>Cancelar</button></form></td>";
                        echo "</tr>";
                    }
